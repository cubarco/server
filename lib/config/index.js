...
if (['filesystem', 's3', 'minio', 'imgur', 'azure', 'lutim', 'picgogh'].indexOf(config.imageUploadType) === -1) {
  logger.error('"imageuploadtype" is not correctly set. Please use "filesystem", "s3", "minio", "azure", "lutim", "picgogh" or "imgur". Defaulting to "filesystem"')
