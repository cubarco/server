...
module.exports = {
  ...
  picgogh: {
    repo: process.env.CMD_PICGO_GH_REPO,
    token: process.env.CMD_PICGO_GH_TOKEN,
    path: process.env.CMD_PICGO_GH_PATH,
    customUrl: process.env.CMD_PICGO_GH_CUSTOMURL,
    branch: process.env.CMD_PICGO_GH_BRANCH
  },
